        ...
        <section>
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
              <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-faculty text-ranin-main">
                Legalitas
              </h2>
              <p className="font-jost text-black sm:text-xl">
              ...
              <article className="p-6 rounded-lg border border-gray-200 shadow-md bg-ranin-main border-gray-700">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-4">
                    <span className="font-medium text-ranin-white">
